void main(List<String> arguments) {
  ...
  print('Father bear eats ${fatherBear.eatFish(fatherBear.numberOfFish)} '
      'fishes. And he sleeps for '
      '${fatherBear.sleepAfterEatingFish(fatherBear.hourOfSleep)} hours.');
...
class Bear {
  ...
  Bear(int numOfFish, int hourOfSleep) {
    // constructor
    numberOfFish =
        numOfFish; //using this keyword to point out the current class object
